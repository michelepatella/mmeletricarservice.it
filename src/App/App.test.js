...
// Mocks
jest.mock("./use-cookie-consent/use-cookie-consent.js", () => ({
	useCookieConsent: () => ({
...
jest.mock("../components/Menu/MenuWrapper/MenuWrapper.js", () => () => (
	<div data-testid="menu-wrapper" />
));
jest.mock("../components/CookieConsentBanner/CookieConsentBanner.js", () => () => (
	<div data-testid="cookie-banner" />
));
jest.mock("../components/CookieButton/CookieButton.js", () => () => (
	<div data-testid="cookie-button" />
));
jest.mock("../components/SectionsWrapper/SectionsWrapper.js", () => ({ children }) => (
...
jest.mock("../sections/OurValues/OurValues.js", () => () => (
...
jest.mock("../sections/Contacts/Contacts/Contacts.js", () => () => (
...
describe("App", () => {
	...
	it("should render key components correctly", () => {
		...
		expect(screen.getByTestId("used-cars-section")).toBeInTheDocument();
		expect(screen.getByTestId("where-we-are-section")).toBeInTheDocument();
		expect(screen.getByTestId("contacts-section")).toBeInTheDocument();

		// Sections wrapper
		expect(screen.getByTestId("sections-wrapper")).toBeInTheDocument();
	});
});