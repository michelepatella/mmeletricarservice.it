import '../../styles/components/DivDoveSiamo.css';
        ...
        <>
            ...
            <div className="divDoveSiamo">
                ...
                <Flex
                    ...
                    align="start"
                    vertical
                    className="title-and-icon-container-dove-siamo">

                    <Flex className="flex-division-dove-siamo">

                        {/* Title */}
                        <p className="dove-siamo-division-title">
                            {title}
                        </p>

                        {/* Icon */}
                        <img
                            className="dove-siamo-division-icon"
                            src={icon}
                            alt="dove-siamo-icon"/>
                ...
                {/* Description */}
                <p
                    className="dove-siamo-division-description"
                    ref={subtitleRef}
