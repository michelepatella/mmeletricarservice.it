...
import {DOVE_SIAMO_DIVISIONS, DOVE_SIAMO_TITLE, GOOGLE_MAPS_UNAVAILABLE_DESCRIPTION} from "../utility/constants";
                    ...
                    <Row className="dove-siamo-grid">
                        ...
                        {cookiesAccepted ? (
                            ...
                            <div className="google-map-container"
                                ...
                                <p className="google-map-unavailable-description">{GOOGLE_MAPS_UNAVAILABLE_DESCRIPTION}</p>
                            </div>}
                    </Row>
                </Row>
