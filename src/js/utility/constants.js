...
export const SERVIZI = [
    ...
    {title: "Installazione antifurti satellitari Igla e meccanici defender", description: "Soluzioni antifurto avanzate per la protezione del tuo veicolo: blocco motore elettronico, protezioni meccaniche per defender e tracciamento satellitare in tempo reale.", icon: '/icons/antiTheftIcon.svg'}
];
