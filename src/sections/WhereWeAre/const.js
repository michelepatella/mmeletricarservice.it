/**------------- Where We Are constants -------------**/

/* — Title — */
export const WHERE_WE_ARE_TITLE = "Dove trovarci.";

/* — Working Hours — */
export const WHERE_WE_ARE_WORKING_HOURS_TITLE =
	"Orari d'apertura.";
export const WHERE_WE_ARE_WORKING_HOURS_DESCRIPTION =
	"- <strong>Lun-Ven</strong>: 08:30-13:00 / 15:00-19:00 <br>" +
	"- <strong>Sab</strong>: 08:30-13:00";

/* — Google Maps — */
export const WHERE_WE_ARE_GOOGLE_MAPS_LINK =
...
export const WHERE_WE_ARE_GOOGLE_MAPS_CONTAINER_CLASS_NAME =
	"google-maps-container";
export const WHERE_WE_ARE_GOOGLE_MAPS_IFRAME_CLASS_NAME =
	"google-maps-iframe";
export const WHERE_WE_ARE_GOOGLE_MAPS_IFRAME_TITLE =
	"google-maps";

/* — Fallback — */
export const WHERE_WE_ARE_GOOGLE_MAPS_UNAVAILABLE_DESCRIPTION =
