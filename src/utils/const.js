...
export const USED_CAR_INFO_KEY = "usedCarInfo";
export const USED_CARS_OVERVIEW_KEY = "usedCarsOverview";
...
/**------------- Loading Outlined -------------**/
export const LOADING_OUTLINED_CLASS_NAME =
	"loading-outlined";

/**------------- Horizontal Scroll Label -------------**/
export const HORIZONTAL_SCROLL_LABEL =
...
/**------------- Menu -------------**/
export const MENU_BIG_CONTAINER_CLASS_NAME =
	"menu-container-big";
export const MENU_BIG_MOTION_SECTION_CLASS_NAME =
	"motion-section";
export const MENU_BIG_INITIAL_OPACITY = 0;
export const MENU_BIG_FINAL_OPACITY = 1;
export const MENU_BIG_INITIAL_X_POSITION = -100;
export const MENU_BIG_FINAL_X_POSITION = 0;
export const MENU_BIG_ANIMATION_DURATION = 0.8;
export const MENU_SMALL_CONTAINER_CLASS_NAME =
...
export const MENU_SMALL_CLOSE_OUTLINE_CLASS_NAME =
	"close-outline";
export const MENU_SMALL_CHILDREN_ITEM_CLASS_NAME =
	"ant-Menu-item-child";
export const MENU_ARIA_LABEL = "Menu";

/**------------- Custom Back Button -------------**/
export const CUSTOM_BACK_BUTTON_CLASS_NAME =
	"custom-back-button";
...
export const CUSTOM_TEXT_DEFAULT_OPACITY = 1;
export const CUSTOM_TEXT_CLASS_NAME_PREFIX = "custom-";

/**------------- Custom Block Quote -------------**/
export const CUSTOM_BLOCK_QUOTE_CLASS_NAME =
	"custom-block-quote";
...
/**------------- Info Card -------------**/
export const INFO_CARD_CLASS_NAME = "info-card";
export const INFO_CARD_FLEX_CLASS_NAME = "info-card-flex";
export const INFO_CARD_ICON_CLASS_NAME = "info-card-icon";
export const INFO_CARD_ICON_ALT = "info-card-icon";
...
export const HOME_LAYOUT_CLASS_NAME = "home-layout";
export const HOME_HEADER_CLASS_NAME = "home-header";
export const HOME_CONTENT_CLASS_NAME = "home-content";
...
export const HOME_TITLE_CLASS_NAME = "home-title";
...
export const USED_CARS_CAROUSEL_CONTAINER_CLASS_NAME =
	"carousel-container";
export const USED_CARS_COLLAPSE_CLASS_NAME =
	"used-car-drawer-collapse";
export const USED_CARS_COLLAPSE_OUTER_LIST_CLASS_NAME =
	"used-car-drawer-collapse-outer-list";
export const USED_CARS_COLLAPSE_INNER_LIST_CLASS_NAME =
...
export const GOOGLE_MAPS_CONTAINER_CLASS_NAME =
	"google-maps-container";
export const GOOGLE_MAPS_IFRAME_CLASS_NAME =
	"google-maps-iframe";
export const GOOGLE_MAPS_IFRAME_TITLE = "google-maps";
