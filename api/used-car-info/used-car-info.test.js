...
import usedCarInfoHandler from "./used-car-info.js";
...
describe("usedCarInfoHandler", () => {
	...
	it("should return used car info and status 200 if successful", async () => {
		...
		await usedCarInfoHandler({ query: { id } }, res);
	...
	it("should handle missing id gracefully", async () => {
		...
		await usedCarInfoHandler({ query: {} }, res);
	...
	it("should merge partial data correctly", async () => {
		...
		await usedCarInfoHandler({ query: { id: id } }, res);
	...
	it("should handle getUsedCarImages failure gracefully", async () => {
		...
		getUsedCarImages.mockRejectedValue(
